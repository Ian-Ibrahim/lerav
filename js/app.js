      ...
      // update cart item
var cartItemCount = localStorage.length;
document.getElementById('cart-items-count').innerHTML = Math.floor(cartItemCount / 3);
      // on remove item
      ...
      function removeCartItem(event) {
        ...
        const classList = buttonClicked.parentElement.parentElement.classList;
        localStorage.removeItem(x);
        localStorage.removeItem(classList.item(1))
        localStorage.removeItem(classList.item(2))
        updateCartTotal()
        location.reload()
      }
